...
// WithBackendAPIKey sets the 'Authorization: Bearer <backendAPIKey>' request header.
func WithBackendAPIKey(backendAPIKey string) *core.BackendAPIKeyOption {
	return &core.BackendAPIKeyOption{
