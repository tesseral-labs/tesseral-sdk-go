...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.BackendAPIKey != "" {
		header.Set("Authorization", "Bearer "+r.BackendAPIKey)
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("User-Agent", "github.com/tesseral-labs/tesseral-sdk-go/v0.0.9")
	return headers
}
...
// BackendAPIKeyOption implements the RequestOption interface.
type BackendAPIKeyOption struct {
	BackendAPIKey string
}

func (b *BackendAPIKeyOption) applyRequestOptions(opts *RequestOptions) {
	opts.BackendAPIKey = b.BackendAPIKey
}
